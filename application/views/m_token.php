              ...
              <div class="col-md-7">
                <div class="panel-body">
                  <table class="table table-bordered">
                    <tr><td width="35%">Nama Peserta</td><td width="65%"><?php echo $dp['nama']; ?></td></tr>
                    <tr><td>Nis</td><td><?php echo $dp['nis']; ?></td></tr>
                    <tr><td>Guru</td><td><?php echo $du['nmguru']; ?></td></tr>
                    <tr><td>Mata Pelajaran</td><td><?php echo $du['nmmapel']; ?></td></tr>
                    <tr><td>Nama Ujian</td><td><?php echo $du['nama_ujian']; ?></td></tr>
                    <tr><td>Jumlah Soal</td><td><?php echo $du['jumlah_soal']; ?></td></tr>
